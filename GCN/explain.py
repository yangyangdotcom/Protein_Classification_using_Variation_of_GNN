...
def PPI_to_csv(prot_1, prot_1_seq, explain_prot_1,out, edge_index):
    adr = '/Users/benjamin/Documents/Classification/Graph-redo_work_copy/GCN/explain/'
    ...
    for count, i in enumerate(prot_1):
        ...
        # exit()
        #visualization
        visualize_prot = visualize("/Users/benjamin/Documents/Dataset/Graphs/8000_dataset/data/raw/"+ path[-8:], prot_1_seq[count], top5index, filename, explain_prot_1)
